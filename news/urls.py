...
urlpatterns = [
    ...
    path('news-detail/<slug:news>/', view=NewsDetailPage.as_view(), name='news_detail_page'),
    # path('category-detail/<int:pk>/', view=CategoryDetailPage.as_view(), name='category_detail_page'),
    path('category-detail/<slug:category>/', view=CategoryDetailPage.as_view(), name='category_detail_page'),
]
